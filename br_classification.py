...
out_csv_name = f'../{project}_NB.csv' # saves to project folder's parent directory
...
np.save("f1_scores_NB.npy", array)



'''print(testArray)
array = np.array(testArray)
np.save("data_NB.npy",array)
arrayWeReadIn = np.load("data_NB.npy").tolist()
